...
/>
          ...
          {marketCap1 && (
            <div className="font-semibold bg-gradient-to-r from-[#004CFF] via-[#7A5CFF] to-[#4A00E0] bg-clip-text text-transparent mt-4 whitespace-nowrap overflow-visible text-2xl sm:text-3xl md:text-4xl text-center">
