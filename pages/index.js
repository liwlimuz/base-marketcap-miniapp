...
/>
          ...
          {marketCap1 && (
            <div className="text-2xl font-extrabold bg-gradient-to-r from-[#004CFF] via-[#7A5CFF] to-[#4A00E0] bg-clip-text text-transparent drop-shadow-lg mt-4 text-center whitespace-nowrap">
